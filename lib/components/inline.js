...
class InlineDeclarationResolver {
    ...
    visitElement({name, element, file, buffer = file.classes, modifiers = [], resolverOptions}) {
        ...
        try {
            ...
            const isTypeContext = parentKind === 'type'
            type.typeInfo.isOptionalProperty = isTypeContext && this.visitor.resolver.isOptional(element) && !this.visitor.resolver.isMandatory(element)
