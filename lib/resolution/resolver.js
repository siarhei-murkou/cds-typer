...
const { deepRequire, createToManyAssociation, createToOneAssociation, createArrayOf, createCompositionOfMany, createCompositionOfOne, createKey, createDefault } = require('../printers/wrappers')
...
class Resolver {
    ...
    resolveAndRequire(element, file, options) {
        ...
        // mark properties that carry CDS default values; shape of default can be a literal or object with val
        if (Object.prototype.hasOwnProperty.call(element ?? {}, 'default')) {
            typeName = createDefault(typeName)
        }
